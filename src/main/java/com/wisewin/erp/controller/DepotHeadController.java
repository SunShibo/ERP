...
public class DepotHeadController {
    ...
    public BaseResponseInfo getBuyAndSaleStatistics(HttpServletRequest request) {
        ...
        try {
            ...
            BigDecimal monthReturn = depotHeadService.getBuyAndSaleStatistics("出库", "采购退货",
            ...
            map.put("thisMonthBuy", monthBuy.add(monthReturn));
            res.code = 200;
            res.data = map;
        } catch(Exception e){
            e.printStackTrace();
